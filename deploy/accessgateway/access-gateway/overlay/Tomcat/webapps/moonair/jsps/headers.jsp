...
<nav class="navbar navbar-default">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Moonair Airlines</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#">Search</a></li>
        <li><a href="#">Buy</a></li>
        <li><a href="/moonair/jsps/logout.jsp">Logout</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="container bg-1 text-center">
  ...
  <img src="/moonair/img/voonair_logo.png" class="img-responsive  margin" style="display:inline" alt="Bird" width="350" height="350">
</div>
